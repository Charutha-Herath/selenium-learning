...
public class TextBoxExample {
    ...
    public void textBoxTests(){
        ...
        WebElement clearText = driver.findElement(By.xpath("//*[@id='j_idt88:j_idt95']"));              // Xpath= //tagName[@attribute='value'] // "" Thula me akaraytm assign kala yuthuya
        clearText.clear();
        ...
        driver.findElement(By.id("j_idt88:j_idt99")).sendKeys("charutha@gmail,com" + Keys.TAB + "Confirmed control moved to the next element");
